...
class ProviderConfig(BaseModel):
    ...
    # credentials (typed Any, not imported, to avoid a providers.runtime <->
    # providers.base import cycle - providers/runtime/__init__.py eagerly
    # imports factory.py, which imports this module). None means "exactly
    # one key configured" and every transport falls back to the original
    # single-key code path in that case.
    key_pool: Any = None
