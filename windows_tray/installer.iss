...
; taskkill exits non-zero if nothing matching is running, which Inno Setup
; does not treat as an uninstall failure - nothing else to guard here.
Filename: "{cmd}"; Parameters: "/C taskkill /IM ""{#MyAppExeName}"" /F"; Flags: runhidden; RunOnceId: "KillFCCTray"
