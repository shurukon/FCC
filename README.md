...
> **⚠️ Legal Disclaimer**
>
> This project is **not affiliated with, endorsed by, or sponsored by Anthropic PBC**. "Claude", "Claude Code", and "Anthropic" are registered trademarks of Anthropic PBC. This is an independent, third-party proxy tool that routes API traffic to alternative LLM providers of your choice. Users are solely responsible for complying with the terms of service of Anthropic, OpenAI, and any other upstream provider they configure. The authors assume no liability for misuse, rate-limit violations, or account actions taken by upstream providers.
